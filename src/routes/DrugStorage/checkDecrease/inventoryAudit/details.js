        ...
        <div className='fullCol-fullChild'>
          <Row>
            ...
            <Col span={12} style={{ textAlign: 'right' }}>
              <Button type='primary' style={{marginRight: 8}} onClick={this.confirm} >确认</Button>
              <Button type='danger' className='button-gap' style={{marginRight: 8}} onClick={this.reject}>驳回</Button>
            </Col>
          </Row>
          <Row>
            <Col span={8}>
