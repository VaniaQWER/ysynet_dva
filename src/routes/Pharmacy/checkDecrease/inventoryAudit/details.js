        ...
        <div className='fullCol-fullChild'>
          <Row>
            ...
            <Col span={12} style={{ textAlign: 'right' }}>
              <Button type='primary' style={{marginRight: 8}} onClick={this.confirm} >审核通过</Button>
              <Button type='danger' className='button-gap' style={{marginRight: 8}} onClick={this.reject}>不通过</Button>
            </Col>
          </Row>
          <Row>
            <Col span={8}>
            ...
            <Col span={8}>
              ...
              <div className="ant-form-item-control-wrapper ant-col-xs-24 ant-col-sm-18">
                <div className='ant-form-item-control'>我是盘点审核列表</div>
              </div>
            </Col>
          </Row>
